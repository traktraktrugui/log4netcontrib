...
namespace log4netContrib.Tests
{
    ...
    public class when_count_appender_proxy_is_created
    {
        ...
        public void should_set_recording_error_handler_on_appender()
        {
            ...
            var sut = new CountAppenderProxy(appender, 5);
    ...
    [TestFixture]
    public class when_count_appender_proxy_asked_to_try_and_append_single_event
    {
        [Test]
    ...
    [TestFixture]
    public class when_count_appender_proxy_asked_to_try_and_append_multiple_events
    {
